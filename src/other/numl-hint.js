...
const globalAttrs = {
  ...
  width: ['min()', 'max()', 'minmax({min},{max})', 'clamp({min},{base},{max})'],
  height: ['min()', 'max()', 'minmax({min},{max})', 'clamp({min},{base},{max})'],
  ...
  space: ['1x'],
  border: ['1b', 'top', 'right', 'bottom', 'left', 'color(special)', 'outside', 'center', '2b left inside color(special)'],
  ...
  filter: ['backdrop-blur(1px)', 'saturation(.5)'],
  image: null,
  transform: null,
